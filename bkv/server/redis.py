...
LastEditTime: 2024-08-17 12:37:19
FilePath: /bkv/bkv/server/redis.py
Description: 描述
'''
# encoding=utf-8
...
from . import resp
from .interfaces import KeyType, MUTABLE_KEY, KEY_SET, KEY_STRING, RedisInterface
...
class FakeLuaRuntime:
    ...
    def table(self, **kw):
        raise NotImplementedError("LuaRuntime.table")
